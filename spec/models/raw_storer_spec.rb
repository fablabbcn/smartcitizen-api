...
RSpec.describe RawStorer, :type => :model do
  ...
  before(:all) do
    ...
    Component.create!(id: 4, board: Kit.find(2), sensor: Sensor.find(4), equation: 'x')
    Component.create!(id: 5, board: Kit.find(2), sensor: Sensor.find(5), equation: 'x')
    Component.create!(id: 6, board: Kit.find(2), sensor: Sensor.find(6), equation: 'x')
    ...
    Component.create!(id: 8, board: Kit.find(2), sensor: Sensor.find(8), equation: 'x')
    Component.create!(id: 9, board: Kit.find(2), sensor: Sensor.find(9), equation: 'x')
    Component.create!(id: 10, board: Kit.find(2), sensor: Sensor.find(10), equation: 'x')
    Component.create!(id: 11, board: Kit.find(2), sensor: Sensor.find(11), equation: 'x')
    Component.create!(id: 12, board: Kit.find(3), sensor: Sensor.find(12), equation: '(175.72 / 65536.0 * x) - 53')
    Component.create!(id: 13, board: Kit.find(3), sensor: Sensor.find(13), equation: '(125.0 / 65536.0  * x) + 7')
    Component.create!(id: 14, board: Kit.find(3), sensor: Sensor.find(14), equation: 'x')
    Component.create!(id: 15, board: Kit.find(3), sensor: Sensor.find(7), equation: 'Mathematician.table_calibration({0=>50,2=>55,3=>57,6=>58,20=>59,40=>60,60=>61,75=>62,115=>63,150=>64,180=>65,220=>66,260=>67,300=>68,375=>69,430=>70,500=>71,575=>72,660=>73,720=>74,820=>75,900=>76,975=>77,1050=>78,1125=>79,1200=>80,1275=>81,1320=>82,1375=>83,1400=>84,1430=>85,1450=>86,1480=>87,1500=>88,1525=>89,1540=>90,1560=>91,1580=>92,1600=>93,1620=>94,1640=>95,1660=>96,1680=>97,1690=>98,1700=>99,1710=>100,1720=>101,1745=>102,1770=>103,1785=>104,1800=>105,1815=>106,1830=>107,1845=>108,1860=>109,1875=>110},x)')
    Component.create!(id: 16, board: Kit.find(3), sensor: Sensor.find(15), equation: 'x')
    Component.create!(id: 17, board: Kit.find(3), sensor: Sensor.find(16), equation: 'x')
    Component.create!(id: 18, board: Kit.find(3), sensor: Sensor.find(17), equation: 'x')
    Component.create!(id: 19, board: Kit.find(3), sensor: Sensor.find(18), equation: 'x')
    Component.create!(id: 20, board: Kit.find(2), sensor: Sensor.find(21), equation: 'x')
    Component.create!(id: 21, board: Kit.find(3), sensor: Sensor.find(21), equation: 'x')
  end
